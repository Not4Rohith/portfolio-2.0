            ...
            <div className="flex items-center gap-3 text-muted-foreground">
              {data.albumImageUrl && (
                <Image
                  ...
                  width={28}
                  height={28}
                  className="w-8 h-8 rounded-[10px] shadow-sm border border-white/5"
                  unoptimized
                />
              )}
              ...
              <div className="flex flex-wrap items-baseline gap-x-1.5 min-w-0">
                ...
                >
                  <span className="text-sm text-foreground font-semibold truncate max-w-[160px] sm:max-w-xs group-hover:text-primary transition-colors">
                    {data.title}
                  </span>
                </a>
                <span className="text-muted-foreground text-xs">by</span>
                <span className="text-xs text-muted-foreground truncate max-w-[140px] sm:max-w-xs">
                  {data.artist}
                </span>
              </div>
            </div>
